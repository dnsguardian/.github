...
- **Redundant Resolver** with aggressive blocking powered by
  [Hagezi DNS Blocklists](https://gitlab.com/hagezi/dns-blocklists) –
...
All projects are licensed under **GPLv3**.

- **[safe-harbour](https://gitlab.com/DNSGuardian/safe-harbour)** → Web portal to request unblocking of domains (Safe Harbour)
...
Blocked a legitimate domain? Submit an unblock request through our
**Safe Harbour** portal – fair, transparent and community-reviewed.
...
For encrypted communication, please use `admin@dnsguardian.ch` exclusively –
only this address has a PGP key.

The public key is available on [keys.openpgp.org](https://keys.openpgp.org/search?q=admin%40dnsguardian.ch).
